    ...
    <main role="main">
      <div className="jumbotron container-fluid">
        <div className="container text-center">
          ...
          <form className="form-inline justify-content-center plus" onSubmit={handleSubmit}> 
            <div className="form-group">
              <input
                ...
                placeholder="Titre"
                required
                /* onChange={e => setNewData(e.target.value)} marche pas*/
            ...
            <div className="form-group">
              <button className="btn btn-outline-secondary m1-3">
                Ajouter un livre
              </button>
            </div>
